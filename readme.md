...
| mac OS   | Monterey      | Mac mini late 2014 (4GB RAM, i5 1.4 GHz intel dual core CPU, intel graphics 5000) | 4.71          | 117.71         | ⚠️     | Technically works, it isn't the best for now, with a bit of tinkering you can run it, you have to change  in `forge.forge.cfg` compilerCommand to `clang++ -std=c++17` from my testing 17 is the lowest version you can use. |
